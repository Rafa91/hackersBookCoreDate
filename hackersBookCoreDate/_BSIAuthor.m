...
// Make changes to BSIAuthor.m instead.

#import "_BSIAuthor.h"

const struct BSIAuthorAttributes BSIAuthorAttributes = {
	.name = @"name",
};

const struct BSIAuthorRelationships BSIAuthorRelationships = {
	.books = @"books",
};

@implementation BSIAuthorID
@end

@implementation _BSIAuthor
...
- (BSIAuthorID*)objectID {
	return (BSIAuthorID*)[super objectID];
}
