...
// Make changes to BSITag.m instead.

#import "_BSITag.h"

const struct BSITagAttributes BSITagAttributes = {
	.name = @"name",
};

const struct BSITagRelationships BSITagRelationships = {
	.books = @"books",
};

@implementation BSITagID
@end

@implementation _BSITag
...
- (BSITagID*)objectID {
	return (BSITagID*)[super objectID];
}
